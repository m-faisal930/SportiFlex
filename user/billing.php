...
<meta name="description" content="Billing Address of the User.">
</head>
<body>
...
?>
    ...
    <div class="dashboard-item col-md-8 " style="padding: 0px 70px;">
        <h2 class="text-center" style="margin-top: 35px;">Edit Billing Address</h2>
        <form action="" method = "post">

        <?php
                        $check_update_query = 343;
                        $customer_id = $_SESSION['userID'];
                        $select_query = "SELECT   a.street_address as address, a.city as city, a.postal_code as postcode, c.country_id, c.country_name as country FROM customers cu, countries c, address a WHERE cu.customer_id = a.customer_id AND a.country_id = c.country_id AND a.status = 1  AND a.customer_id = $customer_id;";
...
if (isset($_POST['change_address'])){
    ...
    VALUES ($customer_id, '$address', '$city', '$postcode', $country_id, 1);";
